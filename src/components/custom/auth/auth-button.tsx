    ...
    <form>
      <Button asChild variant="ghost">
        <Link href={url.href} className="flex justify-center items-center gap-2">
          <svg className="h-5 w-5 fill-[#ffffff]" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
            <path
              fillRule="evenodd"
          ...
          <span className="text-white text-sm font-semibold leading-6">{label ?? "Sign In"}</span>
        </Link>
      </Button>
    </form>
  )
